...
test('cbg', async ({}) => {
 ...
 for (const site of sites) {
    const base_url='https://my'+site+'.cbg.163.com/cgi/mweb/pl?equip_level_min=90&equip_level_max=119&price_max=550000&total_score=50000&order_by=selling_time%20DESC'
    await page.goto(base_url);
    await page.waitForLoadState();
    console.log(base_url)
    await page.waitForTimeout(5030); 
    await page.waitForTimeout(40730); 
    ...
    for(var i = 1; i <= 9999; i++) {
      ...
      await page.waitForTimeout(20730); 
